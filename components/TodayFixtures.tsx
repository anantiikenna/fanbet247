        ...
        {todayFixtures.map((match) => (
          <li key={match.fixture_id} className=" w-full flex flex-col gap-5 px-3">
            <div className=' w-full text-xs grid grid-flow-col grid-cols-7 md:grid-cols-10 gap-2 border-b border-[#D0D5DD] border-solid'>
              <div className="col-span-3 flex items-center gap-1 md:py-2 ">
            ...
            <div className='w-full text-xs grid grid-flow-col grid-cols-7 md:grid-cols-10 gap-2 '>
              ...
              <div className='col-span-2 md:col-span-2 flex gap-1'>
                <span className="bg-[#E5E5E5] px-3 py-1 self-center text-[#949799]"><p className='md:hidden'>HT</p><p className='hidden md:flex'>Half Time</p></span>
                <span className="bg-[#E5E5E5] px-3 py-1 self-center text-[#949799]"><p className='md:hidden'>FT</p><p className='hidden md:flex'>Full Time</p></span>
              </div>
                <div className='col-span-1 md:col-span-2 flex gap-1'>
                <span className="bg-[#E5E5E5] px-3 py-1 self-center text-[#949799]"><p className='md:hidden'>H</p><p className='hidden md:flex'>Home</p></span>
